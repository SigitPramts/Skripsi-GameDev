...
{
    // Builds a path for the room, from the startGridPosition to the endGridPosition, and adds movement steps
    // to the return Stack. Returns null if no path is found.
    ...
    // Create a stack vector 3 containing the movement path
