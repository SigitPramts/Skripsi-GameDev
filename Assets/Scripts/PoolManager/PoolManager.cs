...
{
    #region Tooltip
    [Tooltip("Populate this array with prefabs that you want to add to the pool, adn specify the number of gameobjects to be created for each.")]
    #endregion
    ...
    private void Start()
    {
        // Thus singleton gameobject will be the object pool parent
