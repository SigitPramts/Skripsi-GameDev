...
public static class HelperUtilities
{
    ...
    public static bool ValidateCheckPositiveRange(Object thisObject, string fieldNameMinimum, float valueToCheckMinimum, string fieldNameMaximum, float valueToCheckMaximum, bool isZeroAllowed)
    {
        ...
        if (ValidateCheckPositiveValue(thisObject, fieldNameMinimum, valueToCheckMaximum, isZeroAllowed)) error = true;
        if (ValidateCheckPositiveValue(thisObject, fieldNameMaximum, valueToCheckMinimum, isZeroAllowed)) error = true;
